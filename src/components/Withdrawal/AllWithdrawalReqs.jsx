    ...
    return (
        <div>
            <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                <h2 className="text-3xl bold mb-2">All Withdrawal Requests</h2>
                <input
                    type="date"
                    value={filterDate}
                    onChange={(e) => setFilterDate(e.target.value)}
                    className="px-4 py-2 mb-4 rounded border border-gray-300 focus:outline-none focus:border-primary w-[20%]"
                />
                <select
                    value={statusFilter}
                    onChange={(e) => setStatusFilter(e.target.value)}
                    className="ml-2 px-4 py-3 mb-4 rounded border border-gray-300 focus:outline-none focus:border-primary w-[20%]"
                >
                    ...
                    <table className="w-full table-auto">
                        ...
                        <tbody>
                            {currentReqs.map((req, index) => (
                                <tr key={req._id} className="grid grid-cols-7 !text-[14px]">
