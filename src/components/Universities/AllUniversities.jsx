...
const AllUniversitiesComp = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (modalMode === "add") {
        await axiosInstance.post(`/university/create`, {
          ...formData,
        });
        toast.success("University added successfully!");
      } else if (modalMode === "edit") {
        await axiosInstance.patch(`/university/${selectedUniversity}`, {
          ...formData,
        });
    ...
    <div>
              ...
              <tbody>
                {allUniversities.map((item, index) => (
                  <tr key={item._id}>
                    ...
                    <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                      <p className="text-nowrap capitalize text-black dark:text-white">
      ...
      <div className="mt-4 flex items-center justify-center gap-x-4">
        <button
          ...
          className={`dark:bg-gray-700 dark:text-gray-800 rounded bg-[#ddd] px-4 py-2 text-[#333] ${
              ...
              <form onSubmit={handleFormSubmit}>
                ...
                <div className="mt-4 flex justify-end space-x-4">
                  <button
                    ...
                    disabled={!formData.logo || formData.logo === ""}
                  >
                    {loading ? "..." : "Save"}
                  </button>
                  <button
