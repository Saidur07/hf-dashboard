...
const SignInComp = () => {
  ...
  const onSignIn = async (data) => {
    try {
      ...
      if (
        ...
        (res.data.data.role === "admin" || res.data.data.role === "superadmin")
      ) {
  ...
  return (
    <>
      <div>
        <div className="my-auto flex h-screen w-full items-center justify-center rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="flex w-full flex-wrap items-center">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="px-26 py-17.5 text-center">
                <div className="mb-5.5 inline-block text-5xl font-bold">
                  <h2 className="text-[#000]">HF Consultancy Dashboard</h2>
                </div>
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                ...
                <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                  Sign In to HF Consultancy Dashboard
                </h2>
