            ...
            <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                ...
                <div className="max-w-full overflow-x-auto">
                    <table className="w-full table-auto">
                        <thead>
                            <tr className="bg-gray-2 text-left dark:bg-meta-4 grid grid-cols-4">
                        ...
                        <tbody>
                            {currentSubCats.map((cat, index) => (
                                <tr key={cat._id} className="grid grid-cols-4">
                                    ...
                                    <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark flex items-center gap-x-2">
                                        <Image
                                            src={cat.image} alt="category image" width={80} height={80} className="rounded-lg" />
